...
class SettingsPageState extends ConsumerState<SettingsPage> {
  ...
  File? _avatarFile;
  late final _settingProvider = ref.read(settingProvider.notifier);
  ...
  Future<void> _readLocal() async {
    final userId = await _settingProvider.getPref(FirestoreConstants.id);
    final nickname = await _settingProvider.getPref(FirestoreConstants.nickname);
    final aboutMe = await _settingProvider.getPref(FirestoreConstants.aboutMe);
    final avatarUrl = await _settingProvider.getPref(FirestoreConstants.photoUrl);
    final role = await _settingProvider.getPref("role");
  ...
  Future<void> _uploadFile() async {
    ...
    try {
      ...
      final updateInfo = UserChat(
        ...
        nickname: _nickname,
        aboutMe: _aboutMe,
        role: UserRole.values.byName(_role),
      );
      _settingProvider
